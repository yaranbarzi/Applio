...
class Synthesizer(torch.nn.Module):
    ...
    def forward(
        ...
        if y is not None:
            ...
            return o, ids_slice, x_mask, y_mask, (z, z_p, m_p, logs_p, m_q, logs_q), g

        return None, None, x_mask, None, (None, None, m_p, logs_p, None, None), g
    ...
    def infer(
        ...
        f0_prediction: Optional[torch.nn.Module] = None,
    ):
        """
        ...
        if f0_prediction:
            pred_lf0, _, _ = f0_prediction(pitch, m_p, x_mask, g)
